...
const portfolioCategories: { key: string; label: string; badge: string; color: string; projects: Project[] }[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      { img: P.e1, title: 'Дом «Первый»', loc: 'Рязанское шоссе', area: '75 м²', term: '3 мес', price: 'от 1.9 млн ₽', style: 'Минимальный', floors: '1', bedrooms: '2', bathrooms: '1', year: '2023', desc: 'Самый доступный вариант для тех, кто начинает с малого. Каркасная технология, утеплитель 200 мм, металлочерепица, окна ПВХ, электрика, разводка воды.' },
      { img: P.m1, title: 'Коттедж «Надёжный»', loc: 'Щёлковское шоссе', area: '125 м²', term: '6 мес', price: 'от 4.3 млн ₽', style: 'Традиционный', floors: '2', bedrooms: '3', bathrooms: '1', year: '2024', desc: 'Кирпичный дом в традиционном стиле с двускатной кровлей и крытым крыльцом. Надёжный фундамент, утеплённые стены 510 мм, дровяная печь, место под погреб.' },
      { img: P.e1, title: 'Дом «Дачник»', loc: 'Егорьевское шоссе', area: '85 м²', term: '4 мес', price: 'от 2.5 млн ₽', style: 'Дача эконом', floors: '1', bedrooms: '2', bathrooms: '1', year: '2023', desc: 'Быстровозводимый дом для дачников: каркас за 2 месяца, чистовая отделка за 2 месяца. Открытая веранда 20 м², место под огород, подключение к центральным коммуникациям.' },
      { img: P.m2, title: 'Коттедж «Гостеприимный»', loc: 'Носовихинское ш.', area: '140 м²', term: '6 мес', price: 'от 4.8 млн ₽', style: 'Функциональный', floors: '2', bedrooms: '4', bathrooms: '2', year: '2025', desc: 'Удобный дом с продуманным зонированием: гостевая половина на первом этаже, приватная — на втором. Два входа, два санузла, гараж, летняя кухня.' },
      { img: P.e1, title: 'Дом «Ярославский»', loc: 'Ярославское шоссе', area: '98 м²', term: '5 мес', price: 'от 3.3 млн ₽', style: 'Практичный эконом', floors: '2', bedrooms: '3', bathrooms: '1', year: '2024', desc: 'Дом из газобетона D500 с внешним утеплением. Три спальни, просторная кухня, санузел, кладовая. Фасад декоративная штукатурка, кровля мягкая черепица, тёплый пол.' },
    ],
  },
];
